...
<body>
    ...
    <h4 style="text-align:center; text-decoration: underline; margin-bottom:0;">SURAT KETERANGAN DOMISILI</h4>
    ...
    <div class="content">
        ...
        <p>Adalah benar-benar penduduk Desa Pokoh Kidul, dan menurut database yang ada pada kami yang bersangkutan saat ini berdomisili di {{ $record->alamat_domisili }} sejak tahun {{ $record->tahun_domisili }}.
        </p>
