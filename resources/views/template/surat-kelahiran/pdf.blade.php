...
<body>
    ...
    <table class="checkbox-grid">
        <tr>
            <td><input type="checkbox" checked> Kelahiran</td>
        ...
        <tr>
            <td><input type="checkbox"> Kematian</td>
    ...
    <table>
        ...
        <tr>
            ...
            <td>: {{ $record->tempat_dilahirkan }}</td>
        </tr>
        <tr>
            <td>4. Tempat Kelahiran</td>
            <td>: {{ $record->tempat_kelahiran }}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>6. Pukul</td>
            <td>: {{ $record->waktu_lahir }}</td>
        </tr>
        <tr>
            <td>7. Jenis Kelahiran</td>
            <td>: {{ $record->jenis_kelahiran }}</td>
        </tr>
        <tr>
            <td>8. Kelahiran Ke</td>
            <td>: {{ $record->kelahiran_ke }}</td>
        </tr>
        <tr>
            <td>9. Penolong Kelahiran</td>
            <td>: {{ $record->penolongan_kelahiran }}</td>
        </tr>
        <tr>
            <td>10. Berat Bayi</td>
            <td>: {{ $record->berat_bayi }}</td>
        </tr>
        <tr>
            <td>11. Panjang Bayi</td>
            <td>: {{ $record->panjang_bayi }}</td>
        </tr>
    </table>
    ...
    <table>
        ...
        <tr>
            ...
            <td>: {{ $record->sebab_lahir }}</td>
        </tr>
        <tr>
            <td>9. Yang Menentukan</td>
            <td>: {{ $record->yang_menentukan }}</td>
        </tr>
        <tr>
